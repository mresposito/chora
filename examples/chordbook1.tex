...
\vspace{2cm}
\includegraphics[scale=.7]{guitar.png}\\
\vspace{1cm}
...
\section{America} % (fold)
\label{sec:America}
\subsection{A Horse with No Name} % (fold)
...
\end{Verbatim}
\newpage
% subsection A Horse with No Name (end)
% section America (end)
\section{Louis Armstrong} % (fold)
\label{sec:Louis Armstrong}
\subsection{What a Wonderful World} % (fold)
...
\end{Verbatim}
\newpage
% subsection What a Wonderful Worl (end)
% section Louis Armstrong (end)
\section{The Animals} % (fold)
\label{sec:The Animals}
\subsection{House of the Rising Sun} % (fold)
...
\end{Verbatim}
\newpage
% subsection House of the Rising Su (end)
% section The Animals (end)
\section{Lucio Battisti} % (fold)
\label{sec:Lucio Battisti}
\subsection{Un'Avventura} % (fold)
...
% subsection Un'Avventur (end)

% section Francesco Battisti (end)
\subsection{Dieci Ragazze} % (fold)
...
\newpage
\vspace{14cm}
\centerline{\includegraphics{emozioni.png}}
\newpage
% subsection Dieci Ragazze (end)
\subsection{I Giardini di Maggio} % (fold)
...
\end{multicols}
\newpage
% subsection I Giardini di Maggio (end)
\subsection{Il Tempo di Morire} % (fold)
...
\end{Verbatim}
\newpage
% subsection Il Tempo di Morire (end)
\section{The Beatles} % (fold)
\label{sec:The Beatles}
\subsection{Across the Universe} % (fold)
...
\end{Verbatim}
\newpage
% subsection Across the Universe (end)
\subsection{All My Loving} % (fold)
...
\end{Verbatim}
\newpage
% subsection All My Loving (end)
\subsection{All You Need Is Love} % (fold)
...
\end{Verbatim}
\newpage
% subsection All You Need is Love (end)
\subsection{Blackbird} % (fold)
\label{sub:Blackbir}
\begin{Verbatim}[commandchars=\\\{\}]
...
\end{Verbatim}
\newpage
% subsection Blackbir (end)
\subsection{Come Together} % (fold)
...
\end{Verbatim}
\newpage
% subsection Come Together (end)
\subsection{I Am the Walrus} % (fold)
...
\end{Verbatim}
\newpage
% subsection I Am the Walrus (end)
\subsection{I've Just Seen A Face} % (fold)
...
\end{Verbatim}
\newpage
% subsection I've Just Seen A Face (end)
\subsection{Working Class Hero} % (fold)
...
\end{Verbatim}
\newpage
% subsection Working Class Hero (end)
% section The Beatles (end)
\section{Patty Bravo} % (fold)
\label{sec:Patty Bravo}
\subsection{La Bambola} % (fold)
\label{sub:La Bambol}
\begin{Verbatim}[commandchars=\\\{\}]
[Am]Tu mi fai girar
tu mi fai girar
...
\end{Verbatim}
\newpage
% subsection La Bambol (end)
% section Patty Bravo (end)
\section{Ray Charles} % (fold)
\label{sec:Ray Charles}
\subsection{Hit the Road} % (fold)
...
\end{Verbatim}
\newpage
% subsection Hit the Ro (end)
% section Ray Charles (end)
\section{Eric Clapton} % (fold)
\label{sec:Eric Clapto}
\subsection{Wonderful Tonight} % (fold)
...
\end{Verbatim}
\vspace{5cm}
\centerline{\includegraphics{slowhand.png}}

\newpage
% subsection Wonderful Tonig (end)
\subsection{Layla} % (fold)
\label{sub:Layla }
\begin{Verbatim}[commandchars=\\\{\}]
{\bf Intro:}
Dm   Bb   C   Dm (3 times) 
...
\end{Verbatim}
\newpage
% subsection Layla  (end)
% section Eric Clapto (end)
\section{The Clash} % (fold)
\label{sec:The Clas}
\subsection{London Calling} % (fold)
...
\end{Verbatim}
\newpage
% subsection London Calling (end)
% section The Clas (end)
\section{Leonard Cohen} % (fold)
\label{sec:Leonard Cohe}
\subsection{Famous Blue Raincoat} % (fold)
...
\end{Verbatim}
\newpage
% subsection Famous Blue Rainco (end)
\subsection{Master Song} % (fold)
...
\end{Verbatim}
\newpage
% subsection Master Song (end)
\subsection{Suzanne} % (fold)
\label{sub:Suzanne}
\begin{Verbatim}[commandchars=\\\{\}]
{\bf    E               * +                      * +}
...
\end{Verbatim}
\newpage
% subsection Suzanne (end)
\subsection{Teachers} % (fold)
\label{sub:Teachers}
{\bf Capo 2nd fret}
\begin{multicols}{2}
\begin{Verbatim}[commandchars=\\\{\}]
...
\end{multicols}
\newpage
% subsection Teachers (end)
% section Leonard Cohe (end)
\section{Elvis Costello} % (fold)
\label{sec:Elvis Costello}
\subsection{Almost Blue} % (fold)
...
\end{Verbatim}
\newpage
% subsection Almost Blue (end)
% section Elvis Costello (end)
\section{The Cranberries} % (fold)
\label{sec:The Cranberries}
\subsection{Just My Imagination} % (fold)
...
% section The Cranberries (end)
\section{The Cream} % (fold)
\label{sec:The Cream}
\subsection{White Room} % (fold)
...
\end{Verbatim}
\newpage
% subsection White Room (end)
% section The Cream (end)
\section{Lucio Dalla} % (fold)
\label{sec:Lucio Dall}
\subsection{4 Marzo 1943} % (fold)
...
\newpage
\vspace{10cm} \\
\centerline{\includegraphics{4marzo.png}}
\newpage

% subsection 4 Marzo 1943 (end)
% section Lucio Dall (end)
\section{Pino Daniele} % (fold)
\label{sec:Pino Daniele}
\subsection{A Me Piace o'Blues} % (fold)
...
\end{multicols}
\newpage
% subsection A Me Piace o'Blues (end)
\subsection{Je' So Pazzo} % (fold)
...
\end{Verbatim}
\newpage
% subsection Je' So Pazzo (end)
% section Pino Daniele (end)
\section{Dire Straits} % (fold)
\label{sec:Dire Straits}
\subsection{Six Blade Knife} % (fold)
...
\end{Verbatim}
\newpage
% subsection Six Blade Knife (end)
\subsection{Sultans of Swing} % (fold)
...
\end{Verbatim}
\vspace{2cm}
\centerline{\includegraphics[scale=.8]{direstraits.png}}
\newpage
% subsection Sultains of Swing (end)
% section Dire Straits (end)
\section{The Doors} % (fold)
\label{sec:The Doors}
\subsection{The Changeling} % (fold)
...
\end{Verbatim}
\newpage
% subsection The Changeling (end)
\subsection{Crystal Ship} % (fold)
...
\end{Verbatim}
\newpage
% subsection Crystal Ship (end)
\subsection{Hello I Love You} % (fold)
...
% subsection Hello I Love You (end)
\subsection{Light My Fire} % (fold)
...
\end{multicols}
\newpage
% subsection Light My Fire (end)
% section The Doors (end)
\subsection{Love Her Madly} % (fold)
...
\end{Verbatim}
\newpage
% subsection Love Her Madly (end)
\subsection{Riders on the Storm} % (fold)
...
\end{Verbatim}
\newpage
% subsection Riders on the Storm (end)
\subsection{Soul Kitchen} % (fold)
...
\end{Verbatim}
\newpage
% subsection Generale (end)
% section Francesco De Gregori (end)
\section{Bob Dylan} % (fold)
\label{sec:Bob Dyl}
\subsection{Blowing in the Wind} % (fold)
...
\end{Verbatim}
\newpage
% subsection Blowing in the Wi (end)
% section Bob Dyl (end)

\subsection{I Want You} % (fold)
\label{sub:I Want You}
\begin{multicols}{2}
\begin{Verbatim}[commandchars=\\\{\}]
{\bf F}
...
\newpage
% subsection I Want You (end)
\subsection{Hurricane} % (fold)
\label{sub:Hurricane}
\begin{Verbatim}[commandchars=\\\{\}]
{\bf Am   F   Am   F}
...
\end{Verbatim}
\newpage
% subsection Hurricane (end)
\subsection{Just Like a Woman} % (fold)
...
\end{Verbatim}
\vspace{3cm}
\centerline{\includegraphics{woman.png}}
\newpage
% subsection Just Like a Wom (end)
\subsection{Knocking on Heaven's door} % (fold)
...
\end{Verbatim}
\newpage
\centerline{\includegraphics{knock.png}}
\newpage
% subsection Knocking on Heaven's door (end)
\subsection{Like a Rolling Stone} % (fold)
...
\end{Verbatim}
\newpage
% subsection Like a Rolling Stone (end)
\subsection{Love Minus Zero} % (fold)
...
\newpage
% subsection Love Minus Zero (end)
\subsection{Mr. Tamburine} % (fold)
...
\end{Verbatim}
\newpage
% subsection Mr. Tamburine (end)
\subsection{She Belongs to Me} % (fold)
...
\end{multicols}
\newpage
% subsection She Belongs to Me (end)
\subsection{Outlaw Blues} % (fold)
...
\end{multicols}
\newpage
% subsection Outlaw Blues (end)
\subsection{The Times Are A-Changin'} % (fold)
...
\end{Verbatim}
\newpage
\centerline{\includegraphics{changin.png}}
\newpage
% subsection The Times Are A-Changin' (end)
\section{The Eagles} % (fold)
\label{sec:The Eagles}
\subsection{Hotel California} % (fold)
...
\end{Verbatim}
\newpage
% subsection Hotel Californi (end)
% section The Eagles (end)
\section{Fool's Garden} % (fold)
\label{sec:Fool's Garde}
\subsection{Lemon Tree} % (fold)
...
\end{Verbatim}
\newpage
% subsection Lemon Tree (end)

% section Fool's Garde (end)
\section{Iggy Pop} % (fold)
\label{sec:Iggy Pop}
\subsection{The Passenger} % (fold)
...
\end{Verbatim}
\newpage
% subsection The Passenger (end)
% section Iggy Pop (end)
\section{Antonio Carol Jobim} % (fold)
\label{sec:Antonio Carol Jobim}
\subsection{Corcovado (Quiet Nights of Quiet Stars)} % (fold)
...
\end{Verbatim}
\newpage
% subsection Corcovado (Quiet Nights of Quiet Stars) (end)
\subsection{Garota de Ipanema} % (fold)
...
\end{Verbatim}
\newpage
\centerline{\includegraphics{jobim.png}}
\newpage
% subsection Garota de Ipanem (end)
% section Antonio Carol Jobim (end)
\section{Janis Joplin} % (fold)
\label{sec:Janis Jopli}
\subsection{Kozmic Blues} % (fold)
...
% subsection Kozmic Blues (end)
% section Janis Jopli (end)
\subsection{Me and Bobby McGee} % (fold)
...
\end{Verbatim}
\newpage
% subsection Me and Bobby McGee (end)
\section{Jefferson Airplane} % (fold)
\label{sec:Jefferson Airplane}
\subsection{Plastic Fantastic Lover} % (fold)
...
\newpage
\vspace{5cm}
\centerline{\includegraphics{jefferson.png}}
\newpage
% subsection Plastic Fantastic Lover (end)
\subsection{Somebody to Love} % (fold)
...
\end{Verbatim}
\newpage
% subsection Somebody to Love (end)
\subsection{White Rabbit} % (fold)
...
\end{Verbatim}
\newpage
% subsection White Rabbi (end)
% section Jefferson Airplane (end)
\section{Kansas} % (fold)
\label{sec:Kansas}
\subsection{Dust in the Wind} % (fold)
...
\end{Verbatim}
\newpage
% subsection Dust in the Wi (end)
% section Kansas (end)
\section{Ben E. King} % (fold)
\label{sec:Ben E. King}
\subsection{Stand by Me} % (fold)
...
{\bf Chorus}
\end{Verbatim}
% subsection Stand by Me (end)
\newpage
% section Ben E. King (end)
\section{Led Zeppelin} % (fold)
\label{sec:Led Zeppeli}
\subsection{Bron-Y-Aur-Stomp} % (fold)
...
\end{Verbatim}
\newpage
% subsection Bron-Y-Aur-Stomp (end)
\subsection{Going to California} % (fold)
...
\end{Verbatim}
\newpage
% subsection Going to Californi (end)
\subsection{Rock and Roll} % (fold)
...
\end{Verbatim}
\newpage
% subsection Rock and Roll (end)
% section Led Zeppeli (end)
\section{Peggy Lee} % (fold)
\label{sec:Peggy Lee}
\subsection{Fever} % (fold)
\label{sub:Fever}
\begin{Verbatim}[commandchars=\\\{\}]
{\bf Intro: Am C E}
...
\end{Verbatim}
\newpage
% subsection Fever (end)
% section Peggy Lee (end)
\section{Luciano Ligabue} % (fold)
\label{sec:Luciano Ligabue}
\subsection{Ho Perso le Parole} % (fold)
...
\end{multicols}
\newpage
% subsection Ho Perso le Parole (end)
% section Luciano Ligabue (end)
\section{Lou Reed} % (fold)
\label{sec:Lou Ree}
\subsection{Hanging Around} % (fold)
...
\end{Verbatim}
\newpage
% subsection Hanging Arou (end)
\subsection{Perfect Day} % (fold)
...
\end{Verbatim}
\newpage
% subsection Perfect Day (end)
\subsection{Walk On The Wild Side} % (fold)
...
\newpage
% subsection Walk On The Wild Side (end)
% section Lou Ree (end)
\section{Manu Chao} % (fold)
\label{sec:Manu Chao}
\subsection{Bienvenida a Tijuana} % (fold)
...
\end{multicols}
\newpage
% subsection Bienvenida a Tiju (end)
\subsection{King of the Bongo} % (fold)
\label{sub:King of the Bongo}
\begin{multicols}{2}
\begin{Verbatim}[commandchars=\\\{\}]
{\bf 	  Am}
...
\end{multicols}
\newpage
% subsection King of the Bongo (end)
\subsection{Rumba de Barcellona} % (fold)
\label{sub:Rumba de Barcello}
\begin{Verbatim}[commandchars=\\\{\}]
{\bf           Bm            A }
...
\end{Verbatim}
\newpage
% subsection Rumba de Barcello (end)
\subsection{Mr. Bobby} % (fold)
\label{sub:Mr. Bobby}
\begin{Verbatim}[commandchars=\\\{\}]
{\bf 	  Intro: Am  Dm Em}
{\bf  }
...
\end{Verbatim}
\newpage
% subsection Mr. Bobby (end)
% section Manu Chao (end)
\section{Bob Marley} % (fold)
\label{sec:Bob Marley}
\subsection{Iron, Lion, Zion} % (fold)
...
\end{Verbatim}
\newpage
% subsection Road to Zio (end)
\subsection{Jammin'} % (fold)
\label{sub:Jammin'}
\begin{Verbatim}[commandchars=\\\{\}]
{\bf 	Bm	E7	G	F#m7}
...
\newpage
%\vspace{5cm}
%\centerline{\includegraphics{marley.png}}
\newpage
% subsection Jammin' (end)
\subsection{No Woman, No Cry} % (fold)
...
\end{Verbatim}
\newpage
% subsection No Woman, No Cry (end)
\subsection{Redemption Song} % (fold)
\label{sub:Redemption Song}
\begin{Verbatim}[commandchars=\\\{\}]
Redemption song
{\bf     G                     Em7}
...
\end{Verbatim}
\newpage
% subsection Redemption Song (end)
% section Bob Marley (end)
\subsection{Roots Rock Reggae} % (fold)
...
\end{Verbatim}
\newpage
% subsection Roots Rock Reggae (end)
\subsection{Three Little Birds} % (fold)
...
\end{Verbatim}
\newpage
% subsection Three Little Birds (end)
\section{Scott McKenzie} % (fold)
\label{sec:Scott McKenzie}
\subsection{San Francisco} % (fold)
...
\end{Verbatim}
\newpage
% subsection San Francisco (end)
% section Scott McKenzie (end)
\section{Modena City Ramblers} % (fold)
\label{sec:Modena City Ramblers}
\subsection{Il Ballo di Aureliano} % (fold)
...
\end{Verbatim}
\newpage
% subsection Il Ballo di Aureliano (end)
\subsection{Canzone dalla Fine del Mondo} % (fold)
...
\end{Verbatim}
\newpage
\centerline{\includegraphics[scale=.7]{modena.png}}
\newpage
% subsection Canzone dalla Fine del Mo (end)
\subsection{Ebano} % (fold)
\label{sub:Ebano}
\begin{Verbatim}[commandchars=\\\{\}]
{\bf RE- FA DO x2}
...
\end{Verbatim}
\newpage
% subsection Ebano (end)
\subsection{Un Giorno di Pioggia} % (fold)
...
\newpage
% subsection Un Giorno Di Pioggi (end)
\subsection{Quarant'anni} % (fold)
...
\end{Verbatim}
\newpage
% subsection Quarant'anni (end)
\subsection{Remedios la Bella} % (fold)
...
\end{Verbatim}
\newpage
% subsection Remedios la Bell (end)
% section Modena City Ramblers (end)
\section{Morphine} % (fold)
\label{sec:Morphine}
\subsection{Cure for Pain} % (fold)
...
\end{Verbatim}
\newpage
% subsection Cure for Pai (end)
% section Morphine (end)
\section{Nirvana} % (fold)
\label{sec:Nirv}
\subsection{Polly} % (fold)
\label{sub:Polly}
\begin{Verbatim}[commandchars=\\\{\}]
...
\end{Verbatim}
\newpage
% subsection Polly (end)
% section Nirv (end)
\section{Oasis} % (fold)
\label{sec:Oasis}
\begin{multicols}{2}
\subsection{Wonderwall} % (fold)
...
\end{Verbatim}
\newpage
% subsection Wonderwall (end)
% section Oasis (end)
\end{multicols}
\section{Pink Floyd} % (fold)
\label{sec:Pink Floyi}
\subsection{Comfortably Numb} % (fold)
...
\end{Verbatim}
\newpage
% subsection Comfortably Num (end)
% section Pink Floyi (end)
\subsection{Goodbye Blue Sky} % (fold)
...
\end{Verbatim}
\newpage
% subsection Goodbye Blue Sky (end)
\subsection{Hey You} % (fold)
\label{sub:Hey You}
\begin{Verbatim}[commandchars=\\\{\}]
{\bf Em  Dm  Em  Dm}
...
\end{Verbatim}
\newpage
% subsection Hey You (end)
\subsection{Wish You Were Here} % (fold)
...
% subsection Wish You Were Here (end)
\section{Plain White Ts} % (fold)
\label{sec:Plain White Ts}
\subsection{Hey There Delilah} % (fold)
...
\end{Verbatim}
\newpage
% subsection Hey There Delil (end)
% section Plain White Ts (end)
\section{The Queen} % (fold)
\label{sec:The Quee}
\subsection{Crazy Little Thing Called Love} % (fold)
...
\end{Verbatim}
\newpage
% subsection Crazy Little Thing Called Love (end)
% section The Quee (end)
\section{Massimo Ranieri} % (fold)
\label{sec:Massimo Ranieri}
\subsection{O' Surdato 'nnammurato} % (fold)
...
\end{Verbatim}
\newpage
% subsection O' Surdato 'nnammurato (end)
% section Massimo Ranieri (end)
\section{Red Hot Chili Peppers} % (fold)
\label{sec:Red Hot Chili Peppers}
\subsection{Dani Californication} % (fold)
\label{sub:Dani Californicatio}
\begin{Verbatim}[commandchars=\\\{\}]
{\bf Am                    G}
...
\end{Verbatim}
\newpage
% subsection Dani Californicatio (end)
% section Red Hot Chili Peppers (end)
\subsection{Hard To Concentrate} % (fold)
...
\end{Verbatim}
\newpage
% subsection Hard To Concentr (end)
\subsection{Road Trippin'} % (fold)
...
\end{Verbatim}
\newpage
% subsection Road Trippin' (end)
\subsection{Scar Tissue} % (fold)
...
\end{multicols}
\newpage
\subsection{Slow Cheetah} % (fold)
\label{sub:Slow Cheetar}
\begin{multicols}{2}
\begin{Verbatim}[commandchars=\\\{\}]
{\bf Em             G}
...
\end{multicols}
\newpage
% subsection Slow Cheetar (end)
\subsection{Under the Bridge} % (fold)
...
\end{Verbatim}
\newpage
% subsection Under the Bridge (end)
% subsection Scar Tissue (end)
\section{Damen Rice} % (fold)
\label{sec:Damen Rice}
\subsection{Blower's Daughter} % (fold)
...
\end{Verbatim}
\newpage
% subsection Blower's Daugther (end)
\subsection{Volcano} % (fold)
\label{sub:Volcano}
\begin{Verbatim}[commandchars=\\\{\}]
{\bf Am	Am	Am	Am   G}
{\bf F	F	F	F    G}
...
\end{Verbatim}
\newpage
% subsection Volcano (end)
% section Damen Rice (end)
\section{Silvio Rodriguez} % (fold)
\label{sec:Silvio Rodriguez}
\begin{multicols}{2}
\subsection{Ojal\'{a}} % (fold)
\label{sub:Ojal\'{a}}
\begin{Verbatim}[commandchars=\\\{\}]
...
\end{Verbatim}
\newpage
% subsection Ojal\'{a} (end)
% section Silvio Rodriguez (end)
\end{multicols}
\section{Frank Sinatra} % (fold)
\label{sec:Frank Sinatr}
\subsection{My Funny Valentine} % (fold)
...
\end{Verbatim}
\newpage
% subsection My Funny Valentine (end)
% section Frank Sinatr (end)
\section{Simon and Garfunkel} % (fold)
\label{sec:Simon and Garfunkel}
\subsection{59th Street Bridge (Feelin' Groovy)} % (fold)
...
\end{Verbatim}
\newpage
% subsection 59th Street Bridge (Feelin' Groovy) (end)
\subsection{America} % (fold)
\label{sub:Americ}
\begin{Verbatim}[commandchars=\\\{\}]
...
\end{Verbatim}
\newpage
% subsection Americ (end)
\subsection{Bye Bye Love} % (fold)
...
\end{Verbatim}
\newpage
% subsection Bye Bye Love (end)
\subsection{Cecilia} % (fold)
\label{sub:Cecili}
\begin{Verbatim}[commandchars=\\\{\}]
{\bf C                F          C}
...
\end{Verbatim}
\newpage
% subsection Cecili (end)
\subsection{The Dangling Conversation} % (fold)
...
\end{Verbatim}
\newpage
% subsection The Dangling Conversatio (end)
\subsection{Homeward Bound} % (fold)
...
\end{Verbatim}
\newpage
% subsection Homeward Bou (end)
\subsection{I Am a Rock} % (fold)
...
\end{Verbatim}
\newpage
% subsection I Am a Rock (end)
\subsection{Leaves That Are Green} % (fold)
...
\end{Verbatim}
\newpage
% subsection The Leaves That Are Gree (end)
\subsection{Kathy's Song} % (fold)
...
\end{Verbatim}
\newpage
% subsection Kathy's Song (end)
\subsection{Mrs. Robinson} % (fold)
...
\end{Verbatim}
\newpage
% subsection Mrs. Robinso (end)
\subsection{Scarborough Fair} % (fold)
...
\end{Verbatim}
\newpage
% subsection Scarborough Fair (end)
\subsection{The Boxer} % (fold)
\label{sub:The Boxer}
\begin{Verbatim}[commandchars=\\\{\}]
{\bf C                                             Am}
...
\end{Verbatim}
\newpage
% subsection The Boxer (end)
% section Simon and Garfunkel (end)
\subsection{The Sound of Silence} % (fold)
\label{sub:The sound of Silence}
\begin{multicols}{2}
\begin{Verbatim}[commandchars=\\\{\}]
...
\end{multicols}
\newpage
% subsection The sound of Silence (end)
\subsection{Wednesday Morning 3 A.M.} % (fold)
...
\end{Verbatim}
\newpage
% subsection Wednesday Morning 3 A.M. (end)
\section{Cat Stevens} % (fold)
\label{sec:Cat Stevens}
\subsection{Father and Son} % (fold)
...
\end{Verbatim}
\newpage
% subsection Father and So (end)
\subsection{Wild World} % (fold)
\label{sub:Wild Worl}
\begin{Verbatim}[commandchars=\\\{\}]
{\bf Am            D7                  G}
...
\end{Verbatim}
\newpage
% subsection Wild Worl (end)
% section Cat Stevens (end)
\section{Unknown Artist} % (fold)
\label{sec:Unknown Artis}
\subsection{Bella Ciao} % (fold)
...
\end{Verbatim}
\newpage
% subsection Bella Ciao (end)
% section Unknown Artis (end)
\subsection{Contessa} % (fold)
\label{sub:Contess}
\begin{multicols}{2}
\begin{Verbatim}[commandchars=\\\{\}]
{\bf Mi       Do}
...
\end{multicols}
\newpage
% subsection Contess (end)
\subsection{Fischia il Vento} % (fold)
...
\end{Verbatim}
\newpage
% subsection Fischia il Vento (end)
\subsection{Oltre il Ponte} % (fold)
